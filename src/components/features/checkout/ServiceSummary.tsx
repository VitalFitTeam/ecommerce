...
import { Info, Trash2, CheckCircle2, Clock } from "lucide-react";
...
export const ServiceSummary = ({ service, onRemove, isLocked }: Props) => {
  const t = useTranslations("Checkout.MembershipSummary");

  const price = Number(service.lowest_price_member || 0);
